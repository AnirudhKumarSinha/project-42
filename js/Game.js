class Game{
    ...
    play(){
        ...
        for(var plr in allPlayers){
            ...
            text(allPlayers.player1.name + "'s Score:"+allPlayers.player1.score,50,100);
            text(allPlayers.player2.name + "'s Score:" + allPlayers.player2.score, 50, 150)
            text("Note The Game Ends After Your Score Reaches 20",550,780)
       ...
       fill("blue")
        ...
        text("Press Reset Button Below 👇 And Reload The Page To Restart",550,500)
